...
import emptyComments from '@/asset/image/empty_comments.png';
import { ReactComponent as SeeMoreIcon } from '@/asset/svg/ic_kebab.svg';
import DefaultProfileImage from '@/asset/svg/ic_profile.svg';
import { getProductComments } from '@/api/itemApi';
import { ProductComment, ProductCommentListResponse } from '@/types/product';
...
function CommentThread({ productId }: CommentThreadProps) {
  ...
  useEffect(() => {
    ...
    const fetchComments = async () => {
      ...
      try {
        const data: ProductCommentListResponse = await getProductComments({ productId, params });
