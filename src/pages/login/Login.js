  ...
  return (
    <>
      <header>
        <div className="logo">
          <a href="/">
            <img src="/image/logo.png" alt="판다마켓 로고" width="396" height="132" />
          </a>
        </div>
      </header>
      <main>
          ...
          <div className="easy-login-background">
            <div className="easy-login-container">
              ...
              <div className="easy-login-link-box">
                <a href="https://www.google.com/" className="image-link">
                  <img src="image/icon/ic_google.png" alt="google-icon" className="mini-image" />
                </a>
                <a href="https://www.kakaocorp.com/page" className="image-link">
                  <img src="image/icon/ic_kakao.png" alt="kakao-icon" className="mini-image" />
                </a>
              </div>
            </div>
          </div>
