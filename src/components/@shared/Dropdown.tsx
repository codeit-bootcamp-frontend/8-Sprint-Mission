    ...
    <div className="relative">
      <button onClick={toggleIsOpen} suppressHydrationWarning={true}>
        {currentDevice === "mobile" ? (
          ...
          <div className="flex justify-between items-center w-[130px] h-[42px] px-[20px] py-[9px] text-gray-800 bg-gray text-[16px] font-normal border-[1px] rounded-[12px]">
            {itemDict[currentItemValue]}
            <Image
              width={24}
              height={24}
              src="/images/ic_dropdown_arrow.png"
              alt="드롭다운 화살표"
            />
          </div>
        )}
